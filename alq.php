...
<meta charset="utf-8">
  ...
  <title>Karaoke LatinMusic &gt; Alquiler</title>
			...
			<div id="Header">
				...
				<div class="rightside">
					<div class="bot">
						...
						?>
						<div class="where"><h2>Alquiler</h2></div>
					</div>
				</div>
			</div>
			...
			<div id="Content">
				<div class="tabs">
					...
					<ul>
						...
						<?php if(!IS_ADMIN){ echo '<li><a href="contact.php"><span class="gl"><span class="aw">&gt;</span><span>Contactar</span></span></a></li><li><a href="buy.php"><span class="gl"><span class="aw">&gt;</span><span>Comprar</span></span></a></li><li class="selected"><a href="alq.php"><span class="gl"><span class="aw">&gt;</span><span>Alquiler</span></span></a></li>'; } ?>
					</ul>
					</div>
				...
				<div class="container">
					...
					<div class="container-space BUY"><?php echo $CONTENIDO_PAGINA_ALQUILER; ?>
					</div>
